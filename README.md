...
Sou desenvolvedor web em início de carreira, com foco em criação de interfaces e aplicações utilizando JavaScript.  
Estudo de forma autodidata e atualmente estou em formação em programação, desenvolvendo projetos práticos para evoluir minhas habilidades técnicas.

Tenho grande interesse em evoluir como desenvolvedor e contribuir com soluções web modernas e eficientes.
...
- Estruturação avançada de JavaScript
